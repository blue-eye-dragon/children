<template>
  <div id="batchAuthority"
    ...
    <ta-border-layout :layout="{header:'55px'}">
      ...
      <ta-alert :message="'当前批量操作的角色为：'+roleNames"
                type="info"
                showIcon
                class="notice-box" />
          ...
          <ta-row class="fit">
            <ta-col :span="4"
              ...
              <ta-menu mode="inline"
                       ...
                       @click="onSelectMenu">
                <ta-menu-item :key="item.resourceId"
            ...
            <ta-col :span="14"
              ...
              <div style="border:1px solid #e8e8e8"
                ...
                <div class="authority-box">
                  <ta-input placeholder="输入关键字进行过滤"
                            v-model="filterText"
