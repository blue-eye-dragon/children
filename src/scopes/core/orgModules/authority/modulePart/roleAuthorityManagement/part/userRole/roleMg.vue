<template>
  <div id="roleMg"
      ...
      <ta-tabs class="fit content-box">
        ...
        <template slot="tabBarExtraContent">
          <ta-button @click="fnBack">
            <ta-icon type="rollback"></ta-icon> 返回
          </ta-button>
          <ta-button @click="fnAssociateRole"
                     type="primary">分配角色</ta-button>
    ...
    <ta-modal title="分配角色"
              ...
              :maskClosable='false'
              @ok="fnSave">
      <ta-border-layout :layout="{footer: '70px'}"
                        :showBorder="false"
                        :footer-cfg="{showBorder: false}">
        <ta-table :columns="roleColumns"
        ...
        <div slot="footer">
          <ta-pagination style="float: right;margin-top: 20px"
                         showSizeChanger
                         showQuickJumper
