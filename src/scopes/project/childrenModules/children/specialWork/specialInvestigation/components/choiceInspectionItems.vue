<template>
  <div class="modelcont"
    ...
    <ta-tabs :activeKey="nowkey"
             @change="callback">
      <ta-tab-pane tab="儿童福利机构、收留抚养孤弃儿童的民间机构儿童养育情况自查和检查表"
                   key="01">
        <div>
          ...
          <div style="float: left;width: 50%;margin-top: 1.5%;">
            <h3 style="margin-left: 5%;">儿童福利机构、收留抚养孤弃儿童的民间机构儿童养育情况自查和检查表:</h3>
            <div class="chosechild">
              <div v-for="(item,index) in welfareInsList"
                   :key="index"
                   :value="item.indexNum"
                   class="children">
                {{item.indexNum}}
      ...
      <ta-tab-pane tab="散居孤儿保障工作、收养工作自查和检查表"
                   key="02">
        <div>
          <ta-form layout="inline"
                   style="margin: 1.5% 0;"
