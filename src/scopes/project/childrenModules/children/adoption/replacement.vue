      ...
      <div>
        <div class="searchcont">
          <ta-form layout="inline"
            ...
            <!-- <ta-form-item v-show="false" fieldDecoratorId="additionalYesOrNo" :labelCol="{span:2}" :wrapperCol="{span:22}" :fieldDecoratorOptions="{initialValue: '0'}">
            <ta-input  />
          </ta-form-item> -->
            <ta-form-item>
...
export default {
  ...
  data () {
    return {
      ...
      size: 10,
      mixListOptions: {
        mixGetDataListURL: '/adoption/renewAdoptionCertificateList' // 数据列表接口，API地址
      },
