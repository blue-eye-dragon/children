  ...
  data () {
    return {
      ...
      rules: {
        ...
        withPlacingOutPersonRelationShip: this.verificationRulesNotMustFill(
          '被询问人员与送养人关系',
          50
        ),
        withAdopteeRelationShip: this.verificationRulesNotMustFill(
          '被询问人员与送养人关系',
          50
        ),
        enquiredPerson: this.verificationRules('被询问人员', 72),
        recordPerson: this.verificationRules('记录人员', 72),
        enquireRecord: this.verificationRules('询问笔录', 4000, true),
      },
