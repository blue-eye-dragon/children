<template>
  <div style="height:100%" class='tadrawer'>
    <div class="visitbtn" v-if="!basedisabled">
      <ta-button type="primary" class="addbtn" @click="addAdoption">新增</ta-button>
      <ta-popconfirm title="确定删除吗?" @confirm="Batchdeletion" okText="确定" cancelText="取消">
        <ta-button type="danger" :disabled="isdisabled">批量删除</ta-button>
      </ta-popconfirm>
    </div>
    <div>
      <ta-table
      ...
      >
        ...
        <div slot="action" slot-scope="val,obj,index" class="btnlist">
          <span @click="see(val,obj,index)" class="com_textsee">查看</span>
          <span @click="edit(val,obj,index)" v-if="!basedisabled" class="com_textedit">编辑</span>
          <ta-popconfirm
            title="确定删除吗?"
            v-if="!basedisabled"
    ...
    <ta-drawer title="调查信息" width="1200" placement="right" @close="onClose" :visible="visible" :getContainer="setContainer">
      <ta-form class="drawerFrom" :autoFormCreate="(form)=>{this.form = form}" layout="horizontal">
        <ta-col :span="24">
          ...
          <ta-col :span="12">
            ...
            >
              <ta-input :disabled="idedit" :placeholder="idedit?'':'请输入调查地点'" />
            </ta-form-item>
          </ta-col>
        </ta-col>
        <ta-col :span="24">
          <ta-col :span="12">
            ...
            >
              <ta-input :disabled="idedit" :placeholder="idedit?'':'请输入调查人员'" />
            </ta-form-item>
          </ta-col>
          <ta-col :span="12">
            <ta-form-item
            ...
            >
              <ta-input :disabled="idedit" :placeholder="idedit?'':'请输入调查人员职务'" />
            </ta-form-item>
          </ta-col>
        </ta-col>
        <ta-col :span="24">
          <ta-col :span="12">
            ...
            >
              <ta-input :disabled="idedit" :placeholder="idedit?'':'请输入被调查人员'" />
            </ta-form-item>
          </ta-col>
          <ta-col :span="12">
            <ta-form-item
            ...
            >
              <ta-input :disabled="idedit" :placeholder="idedit?'':'请输入被调查人员与申请者关系'" />
            </ta-form-item>
          </ta-col>
        </ta-col>
        <ta-col :span="24">
          <ta-col :span="12">
            <ta-form-item
              ...
              :wrapperCol="{span:15}"
            >
              <ta-input :disabled="idedit" :placeholder="idedit?'':'请输入被调查人员与送养人关系'" />
            </ta-form-item>
          </ta-col>
          <ta-col :span="12">
            <ta-form-item
              ...
              :wrapperCol="{span:15}"
            >
              <ta-input :disabled="idedit" :placeholder="idedit?'':'请输入被调查人员与被收养人关系'" />
            </ta-form-item>
          </ta-col>
        </ta-col>
        <ta-col :span="24">
          <ta-col :span="12">
            ...
            >
              <ta-input :disabled="idedit" :placeholder="idedit?'':'请输入记录人员'" />
            </ta-form-item>
          </ta-col>
        </ta-col>
        <ta-col :span="24">
          ...
          >
            <ta-textarea :disabled="idedit" :placeholder="idedit?'':'请输入调查笔录'" :rows="4" />
          </ta-form-item>
        </ta-col>
      </ta-form>
      <div slot="footer">
        ...
        <ta-button @click="subfamily" v-if="!idedit" type="primary">确定</ta-button>
      </div>
    </ta-drawer>
  </div>
</template>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        withAdoptorRelationShip: this.verificationRules(
          '被调查人员与申请者关系',
          50
        ),
        enquireRecord: this.verificationRules('调查笔录', 1600, true),
      },
    }
  },
  activated() {
