    ...
    <ta-border-layout :header-cfg="{showBorder:true}"
            ...
            <div class="__form-spec-line__">
              <div>
                ...
                <ta-form-item label="是否经编办批准"
                              ...
                              :labelCol="{span:9}"
                              :wrapperCol="{span:15}">
                  <ta-select collection-type="YESNO"
                             placeholder="请选择是否经编办批准" />
                </ta-form-item>
                <!-- <ta-form-item label="机构是否独立"
                              :labelCol="{span:8}"
                              :wrapperCol="{span:16}"
                              class="spilwid1"
                              fieldDecoratorId="isIndependent">
                  <ta-select collection-type="YESNO"
                             v-model="isIndependentVal"
                             placeholder="请选择机构是否独立" />
                </ta-form-item>
                <ta-form-item label
                              v-if="isIndependentVal==Enum.YESNO.FOU"
                              :labelCol="{ span: 0 }"
                              :wrapperCol="{span:24}"
                              fieldDecoratorId="peopleOrWork">
                  <ta-checkbox-group class="grant-checkbox"
                                     :options="[{label:'人员独立',value:'1'},{label:'办公独立',value:'2'},{label:'人员和办公都不独立',value:'9'}]">
                  </ta-checkbox-group>
                </ta-form-item> -->
        ...
        <div style="height: 50px;">
          <div style="float:right;">
            ...
            <!-- <ta-button style=" margin-left: 10px;"
                       class="exportbtn"
                       icon="upload"
                       :disabled="this.nowkey!='1'&&this.nowkey!='2'"
      ...
      <div slot="footer">
        <ta-pagination :defaultCurrent="page"
                       ...
                       @change="pagechange"
                       :url="mixListOptions.mixGetDataListURL12"
                       :ref="mixPageRef" />
      </div>
    </ta-border-layout>
  </div>
...
export default {
  ...
  methods: {
    ...
    see (e) {
      ...
      this.$router.push({
        ...
        query: {
          ...
          parentOrgName: '',
          nowtype: 3,
          orgType: window.parent.indexTool.getUserInfo().orgType,
          id: e.id,
          otherFlag: 'other'
        }
      })
    ...
    Excel () {
      ...
      const url = '/welfareOrgManagement/exportProtectOrgList'
      if (!data.areaId) {
