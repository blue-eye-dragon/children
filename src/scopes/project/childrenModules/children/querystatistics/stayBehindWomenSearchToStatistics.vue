          ...
          <div class="searchcont"
            ...
            <ta-form layout="inline"
              ...
              <ta-form-item label="文化程度"
                ...
                <ta-radio-group :disabled="nowText!='all'&&nowText!='educationLevel'">
                  <ta-radio @click="deuRadio(item.value,'educationLevel')"
                            :value="item.value"
              ...
              <ta-form-item label="健康状况"
                ...
                <ta-radio-group :disabled="nowText!='all'&&nowText!='healthStatus'">
                  <ta-radio @click="deuRadio(item.value,'healthStatus')"
                            :value="item.value"
              ...
              <ta-form-item label="是否登记领证"
                            :labelCol="{span:7}"
                            :wrapperCol="{span:17}"
                            fieldDecoratorId="marriageRegister"
                            class="spilwid1">
                <!-- <ta-radio-group>
                  <ta-radio :value="item.value"
                ...
                <ta-radio-group :disabled="nowText!='all'&&nowText!='marriageRegister'">
                  <ta-radio @click="deuRadio(item.value,'marriageRegister')"
                            :value="item.value"
                            v-for="(item,index) in boolStatus"
                            :key="index">{{item.label}}</ta-radio>
                </ta-radio-group>
              ...
              <ta-form-item label="公婆情况"
                ...
                <ta-radio-group :disabled="nowText!='all'&&nowText!='parentsInLawCase'">
                  <ta-radio @click="deuRadio(item.value,'parentsInLawCase')"
                            :value="item.value"
                            v-for="(item,index) in gongpoCase"
                            :key="index">{{item.label}}</ta-radio>
                </ta-radio-group>
              </ta-form-item>
              <ta-form-item label="获得生产帮扶情况"
                ...
                <ta-radio-group :disabled="nowText!='all'&&nowText!='getHelpCase'">
                  <ta-radio @click="deuRadio(item.value,'getHelpCase')"
                            :value="item.value"
                            v-for="(item,index) in obtainList"
                            :key="index">{{item.label}}</ta-radio>
                </ta-radio-group>
              </ta-form-item>
              <ta-form-item label="家庭经济来源"
                ...
                <ta-radio-group :disabled="nowText!='all'&&nowText!='familyBreadwinner'">
                  <ta-radio @click="deuRadio(item.value,'familyBreadwinner')"
                            :value="item.value"
                            v-for="(item,index) in familySourceList"
                            :key="index">{{item.label}}</ta-radio>
                </ta-radio-group>
              </ta-form-item>
        ...
        <ta-spin tip="加载中..."
          ...
          <ta-table class=" tables table-min-width  hight "
            ...
            <template slot="goStayBehindChildSearch"
              ...
              <a @click="toGoStayBehindWomenSearch(b)"
                 v-else>{{a}}</a>
            </template>
            <template slot="bfb"
                      slot-scope="a, b, c">
...
export default {
  ...
  data () {
    return {
      ...
      isConfirm: '',
      mixListOptions: {
        mixGetDataListURL: '/leftBehindWomenStatistics/queryLeftBehindWomanCount',
      ...
      heathval: '', // 健康状况选择的值
      issearch: false,
      boolStatus: [{ label: '是', value: '0' }, { label: '否', value: '1' }],
