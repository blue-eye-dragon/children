      ...
      <div class="contentin">
        <div class="searchcont"
          ...
          <ta-form layout="inline"
            ...
            <div class="cbox">
              资金类型：<ta-checkbox :indeterminate="indeterminate"
...
export default {
  ...
  data () {
    const tableColumns = [
      {
        ...
        customRender: (text, record, index) => {
          return this.marge(text, record, index, '9')
        }
      },
      {
        title: '区域',
    ...
    return {
      ...
      size: 10,
      mixListOptions: {
        mixGetDataListURL: '/fundAccountSituationList/queryFundAccountStatistic',
  ...
  methods: {
    ...
    // async getareaname () {
    //   let data = await this.getarealabel(this.nowcode)
    //   console.log(data)
    //   if (data) {
    ...
    Excel () {
      ...
      this.exportdata.excelTitle = this.areaname + '-资金到账情况统计表'
      console.log(this.exportdata)
      this.exportFile('/fundAccountStatisticsExportApi/export', this.exportdata)
      this.showOn = false
    },
    handleCancel () {
      this.showOn = false
