      ...
      <div>
              ...
              <div>
                ...
                <ta-form-item label="是否集中供养"
                  ...
                  <ta-select placeholder="请选择是否集中供养">
                    ...
                    <ta-select-option :value="'1'">否</ta-select-option>
                    <ta-select-option :value="'0'">是</ta-select-option>
                  </ta-select>
                </ta-form-item>
              </div>
        ...
        <div style="margin-top:20px">
          ...
          <p v-if="areaLevel == '1'">
            <span>列表展示的数据为:</span>
            1.省级福利机构一个月未处理的超龄儿童;
            2.市级福利机构和区县民政局一个半月未处理的超龄儿童;
            3.区县福利机构两个月未处理的超龄儿童，请督办省级福利机构或市级福利机构或区县民政局或区县福利机构到【福利业务-超龄儿童-超龄管理】页面进行处理。
          </p>
          <p v-if="areaLevel == '2'">
            <span>列表展示的数据为:</span>
            1.市级福利机构和区县民政局一个月未处理的超龄儿童;
            2.区县福利机构一个半月未处理的超龄儿童，请督办市级福利机构或区县民政局或区县福利机构到【福利业务-超龄儿童-超龄管理】页面进行处理
          </p>
          <p v-if="areaLevel == '3'">
            注：列表展示内容为区县民政局和区县福利机构内超龄一个月未处理的孤儿，请区县民政局或督办区县福利机构到【福利业务-超龄儿童-超龄管理】页面及时进行处理。
          </p>
        </div>
      </div>
      <div slot="footer">
...
export default {
  ...
  data () {
    return {
      ...
      mixListOptions: {
        ...
        mixGetDataListURL: '/overseeApi/overSeeGuerByCounty' // 数据列表接口，API地址
      },
      // 默认属性
      mixDataList: [], // 数据列表
      // f分页组件属性
  ...
  methods: {
    ...
    Excel () {
      ...
      const url = '/overseeBusiness/exportOverSeeGuerNum'
