...
const tableColumns = [
  ...
  },
  {
    ...
    width: '18%',
    dataIndex: 'biztype',
    collectionType: 'REPLACEMENTREGISTERCATEGORY'
  },
  {
    title: '登记日期',
    width: '13%',
...
export default {
  ...
  methods: {
    // 所有字典数据获取
    getAllMenuDatas () {
      this.getMenu('REPLACEMENTREGISTERCATEGORY', 'biztypeList') // 补录登记类别下拉框数据
    },
    ...
    userPageParams () {
      ...
      formData['searchType'] = '5'
      return formData
    },
    // 详情
    look (e) {
      this.$emit('replacementLook', e)
    }
  }
}
</script>
