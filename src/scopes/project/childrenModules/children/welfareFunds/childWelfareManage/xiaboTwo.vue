          ...
          <ta-row class="fromcom">
            ...
            <ta-col :span="12">
              <ta-form-item label="使用年度"
                ...
                <ta-year-picker @change="disabledYear"
...
export default {
  ...
  data () {
    return {
      ...
      mixListOptions: {
        ...
        mixAddURL: '/welfareFundAllocate/save', // 数据新增接口，API地址
        mixDeleteURL: '', // 数据删除接口，API地址
        mixEditURL: '/welfareFundAllocate/update' // 数据编辑接口，API地址
      },
      addTableColumns,
      addTableData: [],
  ...
  methods: {
    ...
    getDetails (data) {
      ...
      let dataTab = data.troubledChildAllocateMoneyVoList
      if (this.goType == '2') {
        ...
        this.addTableData = data.troubledChildAllocateMoneyVoList
        this.sumForm.setFieldsValue({
    ...
    async submit (e) {
      ...
      if (isok) {
        ...
        troubledChildAllocateVo.welfareFundAllocateMoneyVoList = this.addTableData
