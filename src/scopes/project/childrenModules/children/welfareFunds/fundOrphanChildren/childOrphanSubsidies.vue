  ...
  data () {
    return {
      ...
      mixListOptions: {
        ...
        mixGetDataListURL: '/orphanLivingExpensesReachAccount/list', // 数据列表接口，API地址
        mixAddURL: '/orphanLivingExpensesReachAccount/save', // 数据新增接口，API地址
        mixDeleteURL: '/orphanLivingExpensesReachAccount/updateDelStateById', // 数据删除接口，API地址
        mixEditURL: '/orphanLivingExpensesReachAccount/update' // 数据编辑接口，API地址
      },
      isdisabled: true,
      visible: false,
      diseasetypeList: [],
