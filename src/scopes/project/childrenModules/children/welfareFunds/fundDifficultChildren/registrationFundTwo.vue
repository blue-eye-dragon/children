  ...
  data () {
    return {
      ...
      mixListOptions: {
        ...
        mixAddURL: '/troubledChildAllocate/save', // 数据新增接口，API地址
        mixDeleteURL: '', // 数据删除接口，API地址
        mixEditURL: '/troubledChildAllocate/update' // 数据编辑接口，API地址
      },
      addTableColumns,
      addTableData: [],
  ...
  methods: {
    ...
    async submit (e) {
      ...
      if (isok) {
        ...
        troubledChildAllocateVo.troubledChildAllocateMoneyVoList = this.addTableData
