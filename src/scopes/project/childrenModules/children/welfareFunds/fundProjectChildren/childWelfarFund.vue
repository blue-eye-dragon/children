  ...
  data () {
    return {
      ...
      mixListOptions: {
        ...
        mixGetDataListURL: '/childWelfareOrgFundReachAccount/list', // 数据列表接口，API地址
        mixAddURL: '/childWelfareOrgFundReachAccount/save', // 数据新增接口，API地址
        mixDeleteURL: '/childWelfareOrgFundReachAccount/updateDelStateById', // 数据删除接口，API地址
        mixEditURL: '/childWelfareOrgFundReachAccount/update' // 数据编辑接口，API地址
      },
      isdisabled: true,
      visible: false,
      diseasetypeList: [],
