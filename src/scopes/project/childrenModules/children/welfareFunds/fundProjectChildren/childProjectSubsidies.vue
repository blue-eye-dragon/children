    ...
    <ta-border-layout :header-cfg="{showBorder:false}"
      ...
      <ta-drawer title="本级配套资金登记"
        ...
        <ta-form class="drawerFrom"
          ...
          <ta-form-item label="到账单位"
                        fieldDecoratorId="reachAccountUnit"
                        :labelCol="{ span: 6 }"
                        :fieldDecoratorOptions="rules.reachAccountUnit">
            <ta-input placeholder="请输入到账单位"
                      :disabled="disabled" />
          </ta-form-item>
          <ta-form-item label="到账日期"
                        fieldDecoratorId="reachAccountTime"
  ...
  data () {
    return {
      ...
      mixListOptions: {
        ...
        mixGetDataListURL: '/childWelfareFundReachAccount/list', // 数据列表接口，API地址
        mixAddURL: '/childWelfareFundReachAccount/save', // 数据新增接口，API地址
        mixDeleteURL: '/childWelfareFundReachAccount/updateDelStateById', // 数据删除接口，API地址
        mixEditURL: '/childWelfareFundReachAccount/update' // 数据编辑接口，API地址
      },
      isdisabled: true,
      visible: false,
      diseasetypeList: [],
      ...
      rules: {
        ...
        reachAccountUnit: this.verificationRules('到账单位', 72)
      }
    }
  },
  mounted () {
