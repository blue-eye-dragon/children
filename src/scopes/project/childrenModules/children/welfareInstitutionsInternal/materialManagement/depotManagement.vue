      ...
      <div>
        ...
        <ta-table :columns="mixColumns"
          ...
          <div slot="operate"
               ...
               class="btnlist">
            <a>
              <span @click="seeData(text, record,'0')"
      ...
      <ta-drawer title="物资出库"
        ...
        <ta-drawer title="选择物资"
          ...
          <WarehousingGoods v-if="nameDrawer"
                            ...
                            :goType="goType"
                            ref="mychild"
                            url="/welfareMaterialOutHouse/queryMaterialList"></WarehousingGoods>
          <div slot="footer">
            <ta-button key="back"
        ...
        <ta-drawer title="选择领用人"
          ...
          <SelectPeople v-if="peopleDrawer"
                        ...
                        :goType="goType"
                        ref="mychildP"
                        url="/welfareMaterialOutHouse/queryWelfareEmployeeList"></SelectPeople>
          <div slot="footer">
            <ta-button key="back"
      ...
      <ta-drawer :title="type==0?'物资出库编辑':'物资出库详情'"
        ...
        <ta-drawer title="选择物资"
          ...
          <WarehousingGoodsEdit v-if="nameDrawer"
                                ...
                                :goType="goType"
                                ref="mychild"
                                url="/welfareMaterialOutHouse/queryMaterialList"></WarehousingGoodsEdit>
          <div slot="footer">
            <ta-button style="marginRight: 8px"
  ...
  data () {
    return {
      ...
      mixListOptions: {
        ...
        mixGetDataListURL: '/welfareMaterialOutHouse/list', // 数据列表接口，API地址
        mixGetDataListIsPage: true, // 数据列表接口，是否需要分页？
        mixScreen: true, // 是否需要筛选
        mixDeleteURL: '/welfareMaterialOutHouse/updateDelStateById', // 删除接口，API地址
        mixExportURL: '/welfareMaterialOutHouse/export', // 导出接口，API地址
        mixAddURL: '/welfareMaterialOutHouse/save', // 新增接口
        mixEditURL: '/welfareMaterialOutHouse/update', // 编辑接口
        mixListURL: '/welfareMaterialOutHouse/queryMaterialList', // 选择物品列表接口
        mixTypeURL: '/welfareMaterialType/queryMaterialType', // 获取物资类型
        mixSelectPeopleURL: '/welfareMaterialOutHouse/queryWelfareEmployeeList' // 获取领用人
      },
      dataSource: [],
      mixColumns,
  ...
  methods: {
    ...
    getGoods () {
      ...
      if (_self.mixRowSelectionName.selectedRowValuesName.length > 0) {
        ...
        _self.$nextTick(() => {
          if (this.nowType == '1') {
            _self.addTableData = _self.mixRowSelectionName.selectedRowValuesName
          } else {
    ...
    changeData ({ newData, record, columnKey }) {
      ...
      } else if (newData > 99999999) {
        newData = 1
        this.$message.error('数量最大为8位正整数')
      }
