  ...
  data () {
    return {
      ...
      mixListOptions: {
        ...
        mixGetDataListURL: '/reductionChildRequestApi/pageReductionChildCheck' // 数据列表接口，API地址
      },
      // f分页组件属性
  ...
  methods: {
    ...
    addAdoption (e) {
      ...
      this.$router.push({
        ...
        query: { id: e.id, childReductionId: e.childReductionId, workflowId: e.workflowId, workflowPointId: e.workflowPointId, flag: flag }
      })
    },
    gobatch () {
      let tag = true
