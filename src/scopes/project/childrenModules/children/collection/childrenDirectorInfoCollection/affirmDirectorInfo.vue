    ...
    <ta-border-layout :header-cfg="{showBorder:true}"
      ...
      <div>
        ...
        <ta-table :columns="mixColumns"
                  ...
                  bordered>
                  <!-- :columns="nowkey == '9'?mixColumns1:mixColumns" -->
    ...
    <div>
      ...
      <ta-drawer title="认领"
        ...
        <ta-form :autoFormCreate="(form)=>{this.form = form}"
          ...
          <ta-form-item label="姓名"
                        fieldDecoratorId="name"
                        :fieldDecoratorOptions="this.verificationRules('名称', 72,true)">
          ...
          <ta-form-item label="村/社区名称"
                        ...
                        :fieldDecoratorOptions="this.verificationRules('村/社区名称', 200,true)">
