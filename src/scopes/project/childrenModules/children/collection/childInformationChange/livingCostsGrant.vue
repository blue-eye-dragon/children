  ...
  <ta-row>
    ...
    <ta-col :span="6">
      <ta-form-item label="起领年月"
                    ...
                    :fieldDecoratorOptions="!controMustTip2?rules.startReceiveDate:rules.receiverToChildRelation2"
                    :labelCol="{ span: 8 }"
                    :wrapperCol="{ span: 16 }">
      ...
      <ta-form-item label="证件类型"
                    ...
                    :labelCol="{ span: 8 }"
                    :wrapperCol="{ span: 16 }">
        <ta-select :placeholder="(isSelf||isSelf2)?'':'请选择证件类型'"
    ...
    <ta-col :span="6">
      <ta-form-item label="末领年月"
                    ...
                    :fieldDecoratorOptions="!controMustTip2?rules.endReceiveDate:rules.receiverToChildRelation2"
                    :labelCol="{ span: 8 }"
                    :wrapperCol="{ span: 16 }">
        <ta-month-picker style="width:100%"
                         placeholder='请选择末领年月'
                         ...
                         :disabled='isFlag?true:disabled?disabled:controMustTip2' />
      </ta-form-item>
      <ta-form-item label="领取人证件号码"
                    ...
                    :labelCol="{ span: 9 }"
                    :wrapperCol="{ span: 15 }">
        <ta-input :placeholder="(isSelf||isSelf2)?'':'请输入领取人证件号码'"
                  @blur="sendDataToRecipient('receiverIdCard')"
      ...
      <ta-row>
        ...
        <ta-col>
          ...
          <ta-form-item label="领取人联系电话"
                        ...
                        :fieldDecoratorOptions="isSelf2?rules.contactNumber2:((!controMustTip2&&controMustTip)?rules.contactNumber:rules.contactNumber2)"
                        :labelCol="{ span: 9 }"
                        :wrapperCol="{ span: 15 }">
  ...
  data () {
    return {
      ...
      rules: {
        ...
        startReceiveDate: this.verificationRules('起领年月', true),
        endReceiveDate: this.verificationRules('末领年月', true),
        ...
        securityMoney: this.verificationRules('保障金额', '0'),
