    ...
    <ta-col :span="24">
      ...
      <ta-col :span='8'>
        ...
        <ta-form-item label="证件号码"
                      ...
                      :fieldDecoratorOptions="!(isphonerule ||isphonerule1)?(cordTypes=='01' && !(isphonerule ||isphonerule1)?rules.idCard:this.verificationRules('证件号码',18)):rules.idCard2"
                      :labelCol="{span:9}"
                      :wrapperCol="{span:15}">
          <ta-input :placeholder="disabled?'':'请输入证件号码'"
                    maxlength='18'
                    :disabled="disabled?disabled:cordTypes==0" />
        </ta-form-item>
      </ta-col>
      <ta-col :span='8'>
