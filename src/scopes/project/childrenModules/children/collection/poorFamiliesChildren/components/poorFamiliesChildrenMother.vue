  ...
  <div class="nofy">
    ...
    <ta-col :span='24'>
      ...
      <ta-col :span="12">
        ...
        <ta-form-item label="信息是否完整"
                      fieldDecoratorId="infoCaseOfMother"
                      :labelCol="{ span: 12 }"
                      :wrapperCol="{ span: 12 }"
                      initValue='1'
    ...
    <ta-col :span="12">
      ...
      <ta-form-item label="证件号码"
                    fieldDecoratorId="idCardOfMother"
                    :labelCol="{ span: 9 }"
                    :wrapperCol="{ span: 15 }"
                    v-if="mustTip!='1'"
    ...
    <ta-col :span="12">
      ...
      <ta-form-item label="证件类型"
                    fieldDecoratorId="memberIdTypeOfMother"
                    :labelCol="{ span: 9 }"
                    :wrapperCol="{ span: 15 }"
      ...
      <!-- <ta-form-item label="联系电话"
                    ...
                    :fieldDecoratorOptions="mustTip?rules.contactNumber:rules.contactNumber2"
                    :labelCol="{ span: 9 }"
                    :wrapperCol="{ span: 15 }">
      ...
      <ta-col :span='5'>
        ...
        <ta-form-item label="同现住址"
                      fieldDecoratorId="sameAddressOfMother"
      ...
      <ta-col :span='24'>
        ...
        <ta-form-item label="联系电话"
                    fieldDecoratorId="contactNumberOfMother"
                    :labelCol="{ span: 10 }"
                    :wrapperCol="{ span: 14 }"
    ...
    <ta-col :span="24">
      ...
      <ta-form-item v-if="heathval==Enum.HEALTHSTATUS.OTHER"
                    label="其他"
                    fieldDecoratorId="healthStatusOtherOfMother"
                    :labelCol="{ span: 6 }"
                    :wrapperCol="{ span: 18 }"
      ...
      <div class="canji"
        ...
        <ta-form-item label="残疾类型"
                      fieldDecoratorId="disabledTypeOfMother"
                      :labelCol="{ span: 6 }"
                      :wrapperCol="{ span:18 }"
                      :initValue="[]"
        ...
        <ta-form-item label="残疾等级"
                      fieldDecoratorId="disabledLevelOfMother"
                      :labelCol="{ span: 6 }"
                      :wrapperCol="{ span: 18 }">
