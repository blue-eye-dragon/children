    ...
    <ta-border-layout :header-cfg="{showBorder:true}"
      ...
      <div>
        ...
        <div class="operateBtn radioClass">
          <ta-radio-group v-model="nowkey1"
                          buttonStyle="solid"
                          @change="typechange1">
        ...
        <div class="radioClass"
          ...
          <ta-radio-group v-model="nowkey"
                          ...
                          @change="typechange">
            <!-- 低保儿童      特困儿童    建档立卡儿童  -->
            <ta-radio-button value="1">低保儿童</ta-radio-button>
            <ta-radio-button value="2">特困儿童</ta-radio-button>
            <ta-radio-button value="3">建档立卡儿童</ta-radio-button>
            <!-- <ta-radio-button value="3">已退出列表</ta-radio-button>   后期再议 -->

          </ta-radio-group>
          <div style="float:right">
            <ta-button v-if="nowkey1=='0'"
                       class="exportbtn"
                       icon="upload"
...
export default {
  ...
  data () {
    return {
      ...
      disabled: false,
      mixListOptions: {
        mixGetDataListURL2: '/poolChildren/list',
        mixGetDataListURL1: '/diBaoChildren/list',
        mixGetDataListURL: '/diBaoChildren/list', // /diBaoChildren/list        '/improperCareChildApi/list', // '/worker/list', // 数据列表接口，API地址
  ...
  methods: {
    ...
    Excel () {
      ...
      let url = '/leftOverChild/exportDiBaoChild'
      if (this.nowkey == '2') {
        url = '/leftOverChild/exportTeKunChild'
      } else if (this.nowkey == '3') {
        url = '/leftOverChild/exportJDLKChild'
      }
