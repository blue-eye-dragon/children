  ...
  <div class="nofy">
    ...
    <ta-col :span="24">
      <ta-form-item label="特殊情况"
        ...
        <!--   :fieldDecoratorOptions="this.verificationRulesNotMustFill('其他特殊情况' )"
                     :fieldDecoratorOptions="mustTip?this.verificationRules('其他特殊情况' ):{rules: [{ required: false }]}" -->
    ...
    <ta-col :span="12">
      ...
      <ta-form-item label="证件类型"
                    ...
                    :labelCol="{ span: 9 }"
                    :wrapperCol="{ span: 15 }"
                    :fieldDecoratorOptions="(mustTip && islive)?this.verificationRules('证件类型'):{rules: [{ required: false }]}">
      ...
      <ta-form-item label="联系电话"
                    ...
                    :labelCol="{ span: 9 }"
                    :wrapperCol="{ span: 15 }">
        <!-- :fieldDecoratorOptions="(mustTip && islive && isknow)?rules.contactNumber2:rules.contactNumber" -->

        <ta-input maxlength='17'
                  :placeholder="disabled?'':textphone"
    ...
    <ta-col :span="24">
      <ta-col :span='12'>
        <ta-form-item label="现住址情况"
                      ...
                      :labelCol="{span:9}"
                      :wrapperCol="{span:15}"
                      :fieldDecoratorOptions="{rules: [ { required: (mustTip &&isknow&& islive), message: '请选择现住址情况' }], initialValue: ['1']} ">
          <ta-select :placeholder="disabled?'':'请选择现住址情况'"
                     allowClear
                     :disabled="disabled"
                     @change="implicate">
    ...
    <ta-col :span="12">
      ...
      <AddressComponent :labelwidth="labelwidth"
                        ...
                        :isRequire="mustTip && islive"></AddressComponent>

      <AddressComponent :labelwidth="labelwidth"
                        :disabled="disabled?true:citizenship"
                        ...
                        :arealevel="'4'"
                        @adsvalchange="likeOut"
                        :isRequire="mustTip && islive && isknow &&!citizenship"></AddressComponent>
    ...
    <ta-col :span="12">
      <ta-col :span='17'>
        ...
        <ta-form-item label=""
                      ...
                      :fieldDecoratorOptions="(mustTip && islive)?this.verificationRules('详细地址',100):this.verificationRulesNotMustFill('详细地址',100)">
      ...
      <ta-col :span='24'>
        ...
        <ta-form-item label=""
                      ...
                      :labelCol="{ span: 0 }"
                      :wrapperCol="{ span: 24,offset: 1 }"
                      :fieldDecoratorOptions="(mustTip && islive && isknow&&!citizenship)?this.verificationRules('详细地址',100):this.verificationRulesNotMustFill('详细地址',100)">
    ...
    <ta-col :span="24">
      ...
      <ta-form-item label="健康状况"
                    ...
                    :labelCol="{ span: 6 }"
                    :wrapperCol="{ span: 18 }"
                    :fieldDecoratorOptions="(mustTip && islive && isknow)?this.verificationRules('健康状况'):{rules: [{ required: false }]}">
      ...
      <ta-form-item label="家庭经济来源"
                    ...
                    :initValue="[]"
                    v-if="mustTip"
                    :require="(islive && isknow)?{message:'请选择家庭经济来源'}:false">
...
export default {
  ...
  methods: {
    ...
    mustController (v) {
      ...
      this.thisP.familyBreadwinners = false
      if (this.types == 1) {
    ...
    changeCardType (v) {
      this.thisP.changeCardType(v, this.types)
    },
    // 地址传值
    setAddressFMNow () {
