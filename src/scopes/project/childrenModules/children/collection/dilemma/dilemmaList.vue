      ...
      <div>
        <div class="visitbtntop">
          ...
          <ta-radio-group v-model="nowkey"
            ...
            <ta-radio-button value="1">采集列表</ta-radio-button>
...
export default {
  ...
  data () {
    return {
      ...
      disabled: false,
      mixListOptions: {
        mixGetDataListURL: '/DilemmaChildApi/list', // '/worker/list', // 数据列表接口，API地址
  ...
  methods: {
    ...
    async del (v, o) {
      const res = await this.post('/DilemmaChildApi/updateDelStateById', { id: o.dilemmaChildId })
      if (res.errors) {
