  ...
  <div class="nofy">
    ...
    <ta-col :span="12">
      ...
      <ta-form-item label="证件号码"
        ...
        <!-- :fieldDecoratorOptions="(mustTip=='0'||cardType=='01')?rules.idCard2:this.verificationRulesNotMustFill('证件号码',18)"> -->
    ...
    <ta-col :span="12">
      ...
      <ta-form-item label="联系电话"
                    ...
                    :fieldDecoratorOptions="mustTip?rules.contactNumber2:rules.contactNumber"
                    :labelCol="{ span: 9 }"
                    :wrapperCol="{ span: 15 }">
