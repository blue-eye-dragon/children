  ...
  <ta-row>
    ...
    <ta-col :span="12">
      <ta-form-item label="登记机关"
                    ...
                    :require="{message:'请输入原登记机关'}">
        <ta-input placeholder="请输入原登记机关"
                  :disabled="true" />
      </ta-form-item>
    </ta-col>
    <ta-col :span="24">
      <ta-form-item label="送养人提供的证件情况"
                    :fieldDecoratorOptions="this.verificationRules('送养人提供的证件情况', 200,true)"
                    :labelCol="{ span: 3 }"
                    :wrapperCol="{ span: 21 }"
      ...
      <ta-form-item label="收养人提供的证件情况"
                    :fieldDecoratorOptions="this.verificationRules('收养人提供的证件情况', 200,true)"
                    :labelCol="{ span: 3 }"
                    :wrapperCol="{ span: 21 }"
      ...
      <ta-form-item label="审核意见"
                    ...
                    :fieldDecoratorOptions="this.verificationRules('审核意见', 200,true)">
    ...
    <ta-col :span="12">
      <ta-form-item label="印制号"
                    ...
                    :fieldDecoratorOptions="this.verificationRules('印制号', 50)">
...
export default {
  ...
  methods: {
    ...
    async getcauseforrelease () {
      let data = await this.getDictionaries('CAUSEFORRELEASE')
