  ...
  <div class="nofy">
      ...
      <ta-form-item label="特殊情况"
        ...
        <ta-radio-group @change="zkChange"
          ...
          <ta-radio :value="item.value"
                    ...
                    @click="goHandle(item.value,'otherSpecialCircumstances',true)"
                    :key="index">{{item.label}}</ta-radio>
    ...
    <ta-col :span="12">
      ...
      <AddressComponent :labelwidth="labelwidth"
                        ...
                        :arealevel="'4'"
                        @adsvalchange="likeOut"
                        :isRequire="mustTip && islive && isknow"></AddressComponent>
    ...
    <ta-col :span="12">
      ...
      <ta-col :span='24'>
        ...
        <ta-form-item label=""
                      ...
                      :fieldDecoratorOptions="(mustTip && islive && isknow)?this.verificationRules('详细地址',100):this.verificationRulesNotMustFill('详细地址',100)">
    ...
    <ta-col :span="24">
      ...
      <ta-form-item label="健康状况"
        ...
        <ta-radio-group @change="onChangeFM"
          ...
          <ta-radio :value="item.value"
                    @click="goHealth(item.value,'healthStatus', true)"
...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        ...
        contactNumber2: this.verificationRules('联系电话', {
          type: 'phone'
        }),
  ...
  methods: {
    ...
    goHandle(val, id, b) {
      this.$emit('goHandle',val, id, b)
    },
    goHealth(val, id, b) {
      this.$emit('goHealth',val, id, b)
    },
    setMulti (e) {
    ...
    likeOut () {
      ...
      let nowData = formName.getFieldsValue()
    ...
    likeaddress (q) {
      ...
      let data = formName.getFieldsValue()
      this.$nextTick(() => {
        if (q == '1') {
          let arrs = []
