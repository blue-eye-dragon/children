    ...
    <ta-border-layout :header-cfg="{showBorder:false}"
      ...
      <div class="contentin">
        ...
        <ta-table class="tables table-min-width"
          ...
          <span slot="curStatus"
                slot-scope="a, b, c">
            <!-- CollectionLabel('MEDICAL_RESCUE_APPLY_LIST_STATUS',a) -->
...
export default {
  ...
  data () {
    return {
      ...
      mixListOptions: {
        ...
        mixGetDataListURL: '/medicalRescue/pageApplyRecordList', // 数据列表接口，API地址
        mixAddURL: '', // 新增接口
        mixEditURL: '', // 编辑接口
  ...
  methods: {
    ...
    async dels (text, obj, index) {
      await this.post('/medicalRescue/updateDelStateById', { id: obj.id }).then(
        res => {
          if (res.errors == null) {
