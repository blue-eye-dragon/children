  ...
  <ta-row class="fromcom">
    ...
    <ta-col :span="8">
      <ta-form-item label="联系电话"
                    ...
                    :fieldDecoratorOptions="rules.contactTelephone">
      ...
      <div v-for="(i,e) in guardianArray"
        ...
        <ta-col :span="8">
          <ta-form-item label="与儿童关系"
                        ...
                        :require="{message:'请选择与儿童关系'}">
            <ta-select placeholder="请选择与儿童关系"
                       :disabled="disabled">
              <ta-select-option :value="item.value"
  ...
  methods: {
    ...
    diBaoChange (info) {
      ...
      if (info.file.status === 'removed') {
        if (this.goType == '4' || this.goType == '5' || this.goType == '1') {
          return false
        } else {
          this.$emit('update:diBaoList', info.fileList)
        }
