...
export default {
  ...
  methods: {
    ...
    CreateFullBill (typeStr) {
      ...
      LODOP.PRINT_INITA(0, 0, '25cm', '17cm', '测试解除收养关系证明')// 打印解除收养关系证明
      ...
      LODOP.SET_PRINT_STYLEA(0, 'FontSize', 10)
      LODOP.ADD_PRINT_TEXT('12.882cm', '8.506cm', '1.905cm', '0.6cm', this.printCertificateInfo.placingOutFemaleName)
      LODOP.SET_PRINT_STYLEA(0, 'FontSize', 10)
      ...
      LODOP.SET_PRINT_STYLEA(0, 'FontSize', 10)
      LODOP.ADD_PRINT_SETUP_BKIMG("<img border='0' src='https://etfl.mca.gov.cn//static/img/relive5.jpg'>")// 背景
