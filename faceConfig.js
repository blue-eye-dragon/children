...
const faceConfig = () => {
  return {
    ...
    warName: 'funeral-front',
    // 基础路径,打包发布的时候修改为后端发布服务地址
    // basePath:'http://192.168.5.52:8083/jmgc-cbs',
    // basePath: 'http://192.168.5.15:8083/jmgc-cbs', // 世统
    // basePath: 'http://192.168.5.99:8083/jmgc-cbs', // 春友
    basePath: 'http://192.168.5.68:8081/jmgc-cbs', // 矿学
    // basePath: 'http://192.168.5.52:8083/jmgc-cbs', // 子腾
    // basePath: 'http://123.182.234.124:11601/jmgc-cbs-upgrade',
    // 导出服务地址、
    exportUrl: 'http://127.0.0.1:8088/jmgc-cbs-expor',
    // 开发模式mockServer服务地址
    mockServer: 'http://192.168.5.15:8081/mock/5b68f9b10b81e375f173f0ed',
    // 开发模式后端服务地址
    devServer: 'http://123.182.234.124:11601/jmgc-cbs-upgrade',
    // 浏览器访问地址
