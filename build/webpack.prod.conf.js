        ...
        splitChunks: {
            cacheGroups: {
                ...
                'core-js': {
                    ...
                    chunks: 'all',
                    test (module) {
                        return module.resource && module.resource.indexOf('core-js') >= 0
                    },
                    priority: 22,
                    enforce: true,
                    reuseExistingChunk: true,
                ...
                antd: {
                    ...
                    chunks: 'all',
                    test (module) {
                        return module.resource && (module.resource.indexOf('@ant-design') >= 0 || module.resource.indexOf('tinycolor2') >= 0)
                    },
                    priority: 22,
                    enforce: true,
                    reuseExistingChunk: true,
                ...
                jquery: {
                    ...
                    chunks: 'all',
                    test (module) {
                        return module.resource && module.resource.indexOf('jquery') >= 0
                    },
                    priority: 22,
                    enforce: true,
                    reuseExistingChunk: true,
                ...
                'element-ui': {
                    ...
                    chunks: 'all',
                    test (module) {
                        return module.resource && module.resource.indexOf('element-ui') >= 0
                    },
                    priority: 22,
                    enforce: true,
                    reuseExistingChunk: true,
                ...
                'wang-editor': {
                    ...
                    chunks: 'all',
                    test (module) {
                        return module.resource && module.resource.indexOf('wangeditor') >= 0
                    },
                    priority: 22,
                    enforce: true,
                    reuseExistingChunk: true,
                ...
                lodash: {
                    ...
                    chunks: 'all',
                    test (module) {
                        return module.resource && module.resource.indexOf('lodash') >= 0
                    },
                    priority: 22,
                    enforce: true,
                    reuseExistingChunk: true,
                ...
                'z-render': {
                    ...
                    chunks: 'all',
                    test (module) {
                        return module.resource && module.resource.indexOf('zrender') >= 0
                    },
                    priority: 22,
                    enforce: true,
                    reuseExistingChunk: true,
                ...
                'vue-modules': {
                    ...
                    chunks: 'all',
                    test (module) {
                        return module.resource && (module.resource.indexOf('vuex') >= 0 || module.resource.indexOf('vue-grid-layout') >= 0 || module.resource.indexOf('vue-draggable-resizable-gorkys') >= 0 || module.resource.indexOf('vue-bus') >= 0)
                    },
                    priority: 24,
                    enforce: true,
                    reuseExistingChunk: true,
...
exports.prodChain = (webpackConfig) => {
    ...
    webpackConfig.plugin('extract-css') && webpackConfig.plugin('extract-css').tap(args => {
        ...
        options.filename = 'css/[name].[hash].css'
        options.chunkFilename = 'css/[name].[hash].css'
        return args
    })
    ...
    // FIXME：按需加载情况下，每个页面不会加载自身不需要的组件
